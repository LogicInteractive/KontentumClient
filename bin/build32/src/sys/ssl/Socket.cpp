...
HX_LOCAL_STACK_FRAME(_hx_pos_cd49b9d3f62e0d57_208_write,"sys.ssl.Socket","write",0x9512ac67,"sys.ssl.Socket.write","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",208,0x91bd0920)
...
HX_LOCAL_STACK_FRAME(_hx_pos_cd49b9d3f62e0d57_234_bind,"sys.ssl.Socket","bind",0x5d85ff35,"sys.ssl.Socket.bind","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",234,0x91bd0920)
HX_LOCAL_STACK_FRAME(_hx_pos_cd49b9d3f62e0d57_240_accept,"sys.ssl.Socket","accept",0x6864ea80,"sys.ssl.Socket.accept","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",240,0x91bd0920)
...
void Socket_obj::write(::String content){
            	HX_STACKFRAME(&_hx_pos_cd49b9d3f62e0d57_208_write)
...
void Socket_obj::bind( ::sys::net::Host host,int port){
            	HX_STACKFRAME(&_hx_pos_cd49b9d3f62e0d57_234_bind)
...
HXLINE( 237)		_hx_std_socket_bind(this->__s,host->ip,port);
 ...
 ::sys::net::Socket Socket_obj::accept(){
            	HX_GC_STACKFRAME(&_hx_pos_cd49b9d3f62e0d57_240_accept)
