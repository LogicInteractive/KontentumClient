...
HX_LOCAL_STACK_FRAME(_hx_pos_079f71771048e957_79_copy,"haxe.ds.EnumValueMap","copy",0xa2232c20,"haxe.ds.EnumValueMap.copy","C:\\HaxeToolkit\\haxe\\std/haxe/ds/EnumValueMap.hx",79,0x67888762)
namespace haxe{
namespace ds{
...
HX_DEFINE_DYNAMIC_FUNC2(EnumValueMap_obj,compareArg,return )
 ...
 ::haxe::ds::BalancedTree EnumValueMap_obj::copy(){
            	HX_GC_STACKFRAME(&_hx_pos_079f71771048e957_79_copy)
HXLINE(  80)		 ::haxe::ds::EnumValueMap copied =  ::haxe::ds::EnumValueMap_obj::__alloc( HX_CTX );
HXLINE(  81)		copied->root = this->root;
HXLINE(  82)		return copied;
            	}
