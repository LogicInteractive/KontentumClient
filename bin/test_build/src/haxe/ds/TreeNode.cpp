...
HX_LOCAL_STACK_FRAME(_hx_pos_a547912459d988d9_267_toString,"haxe.ds.TreeNode","toString",0xcf78dce3,"haxe.ds.TreeNode.toString","C:\\HaxeToolkit\\haxe\\std/haxe/ds/BalancedTree.hx",267,0x9022da28)
namespace haxe{
namespace ds{
...
::String TreeNode_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a547912459d988d9_267_toString)
...
HXDLIN( 267)		::String _hx_tmp1 = ((HX_("",00,00,00,00) + ::Std_obj::string(this->key)) + HX_(" => ",7f,53,55,15));
