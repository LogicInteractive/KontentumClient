...
HX_DEFINE_STACK_FRAME(_hx_pos_8a18ca136754c3df_31_new,"haxe.iterators.StringIterator","new",0x04de7dc2,"haxe.iterators.StringIterator.new","C:\\HaxeToolkit\\haxe\\std/haxe/iterators/StringIterator.hx",31,0x63fc1a45)
HX_LOCAL_STACK_FRAME(_hx_pos_8a18ca136754c3df_46_hasNext,"haxe.iterators.StringIterator","hasNext",0xe970abcf,"haxe.iterators.StringIterator.hasNext","C:\\HaxeToolkit\\haxe\\std/haxe/iterators/StringIterator.hx",46,0x63fc1a45)
HX_LOCAL_STACK_FRAME(_hx_pos_8a18ca136754c3df_53_next,"haxe.iterators.StringIterator","next",0x3dcf8d51,"haxe.iterators.StringIterator.next","C:\\HaxeToolkit\\haxe\\std/haxe/iterators/StringIterator.hx",53,0x63fc1a45)
namespace haxe{
namespace iterators{

void StringIterator_obj::__construct(::String s){
            	HX_STACKFRAME(&_hx_pos_8a18ca136754c3df_31_new)
...
bool StringIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_8a18ca136754c3df_46_hasNext)
...
int StringIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_8a18ca136754c3df_53_next)
