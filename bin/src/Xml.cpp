...
HX_LOCAL_STACK_FRAME(_hx_pos_61da4a8008b80acb_367_toString,"Xml","toString",0xb7bb9a43,"Xml.toString","C:\\HaxeToolkit\\haxe\\std/Xml.hx",367,0x6fe08e00)
...
::String Xml_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_61da4a8008b80acb_367_toString)
HXDLIN( 367)		return ::haxe::xml::Printer_obj::print(hx::ObjectPtr<OBJ_>(this),null());
            	}
